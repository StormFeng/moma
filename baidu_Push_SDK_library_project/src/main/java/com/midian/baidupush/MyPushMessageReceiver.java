...
import com.midian.login.bean.PushMessageListBean.PushMessageContent;
/*
...
public class MyPushMessageReceiver extends PushMessageReceiver {
    ...
    public void onBind(Context context, int errorCode, String appid,
        ...
        if (errorCode == 0) {
            ...
            System.out.println("百度推送绑定成功;:::" + channelId);
        }
    ...
    public void Notification(Context context){
        ...
        intent.setClassName("com.midian.moma",
                "com.midian.moma.ui.personal.MessageActivity");
        ...
        notification.setLatestEventInfo(context, "新的消息", "您有新短消息", pendingIntent);
