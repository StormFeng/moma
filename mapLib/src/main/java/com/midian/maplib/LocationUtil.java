...
public class LocationUtil {
	...
	// 一次定位监听器
	private List<OneLocationListener> oneLocationListeners = new ArrayList<OneLocationListener>();
	// 多次定位监听器
...
//		if (locationUtil != null)
	...
	public void startOneLocation(OneLocationListener oneLocationListener) {
		...
		if (!mLocationClient.isStarted()) {
            ...
            System.out.println("启动定位start：：：" + mLocationClient);
		} else {
