...
package midian.baselib.mining.app.zxing.camera;
...
public final class CameraManager {
	...
	private int MAX_FRAME_WIDTH = 800;
	private int MAX_FRAME_HEIGHT = 800;
	...
	public Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			framingRect = new Rect(leftOffset, 0 + top, leftOffset + width,
					height + top);
	...
	public void setTop(int top) {
		...
		int pxTop = Func.Dp2Px(context, top);
		this.top = pxTop;

	}

	public void setMaxWidth(int maxWidth) {
		int pxTop = Func.Dp2Px(context, maxWidth);
		MAX_FRAME_WIDTH = pxTop;
	}

	public void setMaxHeight(int maxHeight) {
		int pxTop = Func.Dp2Px(context, maxHeight);
		MAX_FRAME_HEIGHT = pxTop;
	}
