...
public class PagerSlidingTabStripForOther extends HorizontalScrollView {
    ...
    public int indicatorColor = 0xFF666666;
    ...
    boolean isShowRigthIcon = false;
    boolean isUpLine = false;

    public PagerSlidingTabStripForOther(Context context) {
        this(context, null);
    }

    public PagerSlidingTabStripForOther(Context context, AttributeSet attrs) {
    ...
    public void setShowRigthIcon(boolean isShowRigthIcon) {
        this.isShowRigthIcon = isShowRigthIcon;
    }
    ...
    public void notifyDataSetChanged() {
        ...
        currentPosition = Math.min(currentPosition, tabCount - 1);
    }
    ...
    private void scrollToChild(int position, int offset) {
        ...
        if (tabCount == 0 || position >= pager.getAdapter().getCount()) {
            return;
        }
...
//		}
    ...
    public void setUpLine(boolean isUpLine) {
...
//            positionOffset=0;
            ...
            scrollToChild(position, (int) (positionOffset * tabsContainer
                    .getChildAt(position % tabCount).getWidth()));
    ...
    public void updateTabTextColor(int currentPosition) {
