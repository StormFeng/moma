        ...
        if (lineCount > 0) {
            ...
            if (totalWeight > 0) {
                ...
                for (View prev : row) {
                    ...
                    if (fillX != 0 || fillY != 0) {
                        prev.measure(MeasureSpec.makeMeasureSpec(prev.getMeasuredWidth() + fillX, MeasureSpec.EXACTLY),
...
//			this.orientation = a.getInteger(R.styleable.FlowLayout_orientation1, HORIZONTAL);
...
//		}
    ...
    public enum FillLines {
        NONE(FILL_LINES_NONE), EXCEPT_LAST(FILL_LINES_EXCEPT_LAST), ALL(FILL_LINES_ALL);
