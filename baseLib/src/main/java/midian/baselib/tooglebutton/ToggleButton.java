package midian.baselib.tooglebutton;
...
public class ToggleButton extends View {
	...
	/** 开启颜色 */
	private int onColor = Color.parseColor("#4CD864");
	/** 关闭颜色 */
	...
	public void setup(AttributeSet attrs) {
		...
		borderWidth = typedArray.getDimensionPixelSize(R.styleable.ToggleButton_bordersWidth, borderWidth);
		typedArray.recycle();
	}
