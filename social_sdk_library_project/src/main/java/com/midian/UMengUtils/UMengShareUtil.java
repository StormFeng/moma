...
public class UMengShareUtil {
    ...
    // 微信
    // public final static String WEIXIN_APP_ID = "wx3c215bad8de6f899";
    // public final static String WEIXIN_APP_KEY =
    // "b47d56422c50cfbedce7dcbd1458a066";
    ...
    private void setSMSShareContent(ShareContent frontiaSocialShareContent) {
        ...
        if (frontiaSocialShareContent.getmBitmap() != null) {
            smsImage = new UMImage(mContext, frontiaSocialShareContent.getmBitmap());
        } else {
            smsImage = new UMImage(mContext, frontiaSocialShareContent.getImage());
        }
    ...
    private void setQQShareContent(ShareContent frontiaSocialShareContent) {
        ...
        if (frontiaSocialShareContent.getmBitmap()!=null) {
            qqImage = new UMImage(mContext, frontiaSocialShareContent.getmBitmap());
        } else {
            qqImage = new UMImage(mContext, getShareUrl(frontiaSocialShareContent.getImage()));
        }
    ...
    private void setQQZoneShareContent(ShareContent frontiaSocialShareContent) {
        ...
        if (frontiaSocialShareContent.getmBitmap() != null) {
            qqZoneImage = new UMImage(mContext, frontiaSocialShareContent.getmBitmap());
        } else {
            qqZoneImage = new UMImage(mContext, getShareUrl(frontiaSocialShareContent.getImage()));
        }
    ...
    private void setWeiXinCycleShareContent(ShareContent frontiaSocialShareContent) {
        CircleShareContent mShareContent = new CircleShareContent();
        mShareContent.setShareContent(frontiaSocialShareContent.getSummary());//（分享内容的标题）
        mShareContent.setTitle(frontiaSocialShareContent.getSummary());//微信朋友圈分享只显示标题，故此处应取分享内容的标题
        UMImage qqZoneImage = null;
        if (frontiaSocialShareContent.getmBitmap() != null) {
            qqZoneImage = new UMImage(mContext, frontiaSocialShareContent.getmBitmap());
        } else {
    ...
    public void share(SHARE_MEDIA platform,ShareContent frontiaSocialShareContent) {
        try {
            if (platform == SHARE_MEDIA.QQ) {// qq
                ...
                shareToWeixin(frontiaSocialShareContent);//微信
            } else if (platform == SHARE_MEDIA.WEIXIN_CIRCLE) {// 微信朋友圈
    ...
    public void shareToWeibo(ShareContent frontiaSocialShareContent) {
        ...
        mController.getConfig().closeToast();
        mController.directShare(mContext, SHARE_MEDIA.SINA, new SnsPostListener() {
