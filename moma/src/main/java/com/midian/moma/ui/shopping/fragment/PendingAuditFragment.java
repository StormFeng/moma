...
import com.midian.moma.datasource.PendingAuditDataSource;
import com.midian.moma.itemview.PendingAuditTpl;
 ...
 *
 */
public class PendingAuditFragment extends BaseListFragment<MyorderContent> {
	...
	protected IDataSource getDataSource() {
		return new PendingAuditDataSource(_activity);
	}

	@Override
	protected Class getTemplateClass() {
		return PendingAuditTpl.class;
	}
