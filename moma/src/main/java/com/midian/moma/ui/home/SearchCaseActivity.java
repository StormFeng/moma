...
import com.midian.moma.db.CaseRecordSQLiteOpenHelper;
 ...
 */
public class SearchCaseActivity extends BaseActivity implements TextView.OnEditorActionListener, AdapterView.OnItemClickListener, View.OnFocusChangeListener {
    ...
    private CaseRecordSQLiteOpenHelper helper = new CaseRecordSQLiteOpenHelper(this);
    ...
    public void onSearchKey(String keywords) {
        ...
        //全局搜索列表页
        UIHelper.jump(_activity, SearchCaseResultActivity.class, mBundle);
