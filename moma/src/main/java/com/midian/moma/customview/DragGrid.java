package com.midian.moma.customview;
...
import com.midian.moma.tabs.activity.DragAdapter;
...
public class DragGrid extends GridView {
	...
	public void init(Context context){
		...
		//将布局文件中设置的间距dip转为px
		mHorizontalSpacing = ScreenUtils.dpToPxInt(context, mHorizontalSpacing);
	}
	...
	public void setOnItemClickListener(final MotionEvent ev) {
		setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
				...
				DragAdapter mDragAdapter = (DragAdapter) getAdapter();
				if (mDragAdapter.isHoldPosition(startPosition)||!mDragAdapter.isEdit()) {
					return false;
				}
				...
				dragViewGroup.findViewById(R.id.icon_delete).setVisibility(View.GONE);
...
//		this.windowParams.y = (y - this.win_view_y + this.viewY);//位置的y值
	...
	public void OnMove(int x, int y) {
		...
		DragAdapter mDragAdapter = (DragAdapter) getAdapter();
		if (!mDragAdapter.isHoldPosition(dPosition)) {
