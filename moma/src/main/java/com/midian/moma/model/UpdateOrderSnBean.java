 ...
 */
public class UpdateOrderSnBean extends NetResult {
    public static UpdateOrderSnBean parse(String json) throws AppException {
        UpdateOrderSnBean res = new UpdateOrderSnBean();
        try {
            System.out.println("json::::::::::::"+json);
            res = gson.fromJson(json, UpdateOrderSnBean.class);
