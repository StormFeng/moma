 ...
 */
public class ConfirmOrderBean extends NetResult {
    public static ConfirmOrderBean parse(String json) throws AppException {
        ConfirmOrderBean res = new ConfirmOrderBean();
        try {
            System.out.println("json::::::::::::"+json);
            res = gson.fromJson(json, ConfirmOrderBean.class);
