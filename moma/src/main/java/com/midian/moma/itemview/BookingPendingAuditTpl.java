 ...
 *
 */
public class BookingPendingAuditTpl extends BaseTpl<BookingContent> implements OnClickListener,ApiCallback {
	...
	public BookingPendingAuditTpl(Context context) {
		super(context);
	}

	public BookingPendingAuditTpl(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
...
//		item.setOnClickListener(this);
	...
	protected int getLayoutId() {
		return R.layout.item_booking_pending_audit_tpl;
	}
