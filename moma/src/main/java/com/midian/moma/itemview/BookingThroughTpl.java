 ...
 *
 */
public class BookingThroughTpl extends BaseTpl<BookingContent> implements OnClickListener,ApiCallback {
	...
	public BookingThroughTpl(Context context) {
		super(context);
	}

	public BookingThroughTpl(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
...
//		item.setOnClickListener(this);
	...
	protected int getLayoutId() {
		return R.layout.item_booking_through_tpl;
	}
